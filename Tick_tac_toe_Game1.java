import java.util.*;
public class Tick_tac_toe_Game1{
    ...
    private static boolean isGameFinished(char[][] board,char symbol) {
       ...
       if((board[0][0]== symbol && board[0][1]==symbol && board[0][2]==symbol)  ||
          ...
          return true;
            ...
            System.out.println("The game ended int a tie!");
            return true;
    }

    private static void comouterTurn(char[][] board) {
        Random rand = new Random();
        int coumputerMove;
        while(true){
            coumputerMove = rand.nextInt(9)+1;
            if(isValidMove(board,coumputerMove)){
                break;
            }
        }
        System.out.println("Computer chose "+ coumputerMove);
        placeMove(board, Integer.toString(coumputerMove),'O');
    }
    ...
    private static void playerTurn(char[][] board, Scanner scanner ) {
        String userInput;
        while(true){
        System.out.println("Would you like to play?"+"(1 TO 9)");
